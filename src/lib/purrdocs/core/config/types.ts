// Purrdocs config types used by the local developer docs engine.
/**
 * Main Purrdocs configuration
 */
export interface PurrdocsConfig {
	/** Site metadata */
	site: SiteConfig;
 ...
 */
export const defaultConfig: Partial<PurrdocsConfig> = {
	site: {
		title: 'Documentation',
		baseUrl: '/'
	},
