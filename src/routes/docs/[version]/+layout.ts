...
import type { DocMetadata, DocFrontmatter } from 'purrdocs-core';
import { docToMetadata, generateSidebar } from 'purrdocs-core';
import { docs as parsedDocs } from 'purrdocs:content';
